...
const RegisterPage: React.FC = () => {
    return (
        <>
            {/* <div className="w-screen font-sans text-gray-900 max-w-screen-lg">
                <div className=" ">
                ...
                <div className="md:w-2/3 mx-auto w-full pb-16 sm:max-w-screen-sm md:max-w-screen-md lg:w-1/3 lg:max-w-screen-lg xl:max-w-screen-2xl">
                    <form className="shadow-lg mb-4 rounded-lg border border-gray-100 py-10 px-8">
                        ...
                        <div className="mb-4">
                            ...
                            >
                                ...
                                <option value="SE" selected={true} className="">
                                    Sweden
                                </option>
                        ...
                        <div className="mb-6">
                            <label className="mb-2 flex text-sm">
                                <input type="checkbox" name="accept" className="mr-2" required={true} />
            ...
            <div className="w-screen h-screen bg-[#E9ECEF]">
